...
SELECT COUNT(membercost) FROM cd.facilities
WHERE membercost >= 10;
...
AND bookings.starttime BETWEEN '21-09-2012' AND '22-09-2012'
ORDER BY bookings.starttime;

--How can you produce a list of the start times for bookings by members named 'David Farrell'?
SET search_path = cd;
SELECT members.firstname as FN , members.surname as SN, bookings.starttime from bookings
